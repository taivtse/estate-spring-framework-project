...
@EnableJpaRepositories(basePackages = "com.laptrinhjavaweb.respository")
...
public class PersistenceJpaConfig {
    ...
    private Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.transaction.jta.platform", environment.getProperty("hibernate.transaction.jta.platform"));
